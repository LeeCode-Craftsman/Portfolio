...
/**
 * Direct copy of com.io7m.digal.core.DialControl - DialControl is a final class, and I needed to change a few things.
 * To be honest, I don't know how most of this class works, I just had to make the dial non-clickable and have it go all the way around.
 * I have left com.io7m.digal.core.DialControl as a dependency for this software, so that the original can be found if needed.
 * @see com.io7m.digal.core.DialControl
 */
public class MeterDial extends Region {
	private static final StyleablePropertyFactory<MeterDial> CSS_FACTORY =
			new StyleablePropertyFactory<>(Control.getClassCssMetaData());
	
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_TICK_COLOR =
	...
	private static final CssMetaData<MeterDial, Number> CSS_DIAL_TICK_SIZE =
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_SHADE_COLOR =
			CSS_FACTORY.createColorCssMetaData(
					"dial-shade-color",
					s -> s.shadeColor,
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_EMBOSS_COLOR =
			CSS_FACTORY.createColorCssMetaData(
					"dial-emboss-color",
					s -> s.embossColor,
					Color.gray(1.0, 0.25),
	...
	private static final CssMetaData<MeterDial, Number> CSS_DIAL_EMBOSS_SIZE =
			CSS_FACTORY.createSizeCssMetaData(
					"dial-emboss-size",
					s -> s.embossSize,
					3.0,
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_RADIAL_GAUGE_COLOR =
			CSS_FACTORY.createColorCssMetaData(
	...
	private static final CssMetaData<MeterDial, Number> CSS_DIAL_RADIAL_GAUGE_SIZE =
			CSS_FACTORY.createSizeCssMetaData(
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_INDICATOR_COLOR =
			CSS_FACTORY.createColorCssMetaData(
	...
	private static final CssMetaData<MeterDial, Number> CSS_DIAL_INDICATOR_SIZE =
			CSS_FACTORY.createSizeCssMetaData(
					"dial-indicator-size",
					s -> s.indicatorSize,
					1.5,
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_BODY_COLOR =
			CSS_FACTORY.createColorCssMetaData(
					"dial-body-color",
					s -> s.bodyColor,
					Color.gray(0.4, 1.0),
	...
	private static final CssMetaData<MeterDial, Color> CSS_DIAL_BODY_STROKE_COLOR =
			CSS_FACTORY.createColorCssMetaData(
	...
	private static final CssMetaData<MeterDial, Number> CSS_DIAL_BODY_STROKE_SIZE =
			CSS_FACTORY.createSizeCssMetaData(
	...
	public MeterDial(boolean clockwise)
	{
		CLOCKWISE = clockwise;
		this.converter =
	...
	private static <T> SimpleStyleableObjectProperty<T> propertyOf(
			final MeterDial control,
			final CssMetaData<MeterDial, T> metadata)
	{
		final var name =
			...
			final double valueNow)
	{
		...
		try {
			...
			if (CLOCKWISE){
				g.rotate((valueNow * 360.0) - 90);
			} else {
				g.rotate((valueNow * -360) - 90);
			}
			...
			final double halfHeight)
	{
		...
		try {
			...
			final var tickDelta = 360.0 / (double) count;
			g.rotate(-90.0);
