...
public class Computer {
	...
	/**
	 * Checks to see if a ship has been sunk. I'm not entirely sure if it works, but it could help...
	 */
	...
	private boolean inDiagonal(int[] cell1, int[] cell2) {
		return ((cell1[0] + 1 == cell2[0]) && (cell1[1] + 1 == cell2[1])) ||
				((cell1[0] - 1 == cell2[0]) && (cell1[1] - 1 == cell2[1])) ||
				((cell1[0] + 1 == cell2[0]) && (cell1[1] - 1 == cell2[1])) ||
				((cell1[0] - 1 == cell2[0]) && (cell1[1] + 1 == cell2[1]));
	}
	...
	private boolean inSquare(int[] cell1, int[] cell2, int[] cell3, int[] cell4) {
		return ((cell1[0] == cell2[0]) && (cell3[0] == cell4[0]) && (cell1[1] == cell3[1]) && (cell2[1] == cell4[1])) ||
				((cell2[0] == cell3[0]) && (cell1[0] == cell4[0]) && (cell1[1] == cell2[1]) && (cell3[1] == cell4[1])) ||
				((cell1[0] == cell3[0]) && (cell2[0] == cell4[0]) && (cell1[1] == cell4[1]) && (cell3[1] == cell2[1])) ||
				((cell1[0] == cell2[0]) && (cell3[0] == cell4[0]) && (cell1[1] == cell4[1]) && (cell3[1] == cell2[1])) ||
				((cell1[0] == cell3[0]) && (cell2[0] == cell4[0]) && (cell3[1] == cell4[1]) && (cell1[1] == cell2[1])) ||
				((cell1[0] == cell4[0]) && (cell2[0] == cell3[0]) && (cell1[1] == cell3[1]) && (cell4[1] == cell2[1]));
	}
